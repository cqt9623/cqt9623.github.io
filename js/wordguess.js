...
function about() {
  ...
  pieces.innerHTML = `
    <div id="info" class="board shadow">
      ...
      <p id="love">
        <a href="https://github.com/NNBnh/noi-tu">GitHub</a>
        -
        Made with <i id="heart" class="las la-heart"></i> by <a href="https://www.facebook.com/profile.php?id=100016822741397">Chu Tuan</a>
      </p>
    </div>
  `;
